    ...
    public class DiccionarioTraduccionesService : IDiccionarioTraduccionesService
    {
        ...
        public async Task CargarTraduccionesAsync()
        {
            var claves = new[]
            {
                ...
                "PorcentajeGlobal", "PorcentajeSuplencia", "Presencia", "ProximaFecha", "ProximaParada", "RExitoso",
                "RHorario", "Reload", "RequiredPassword", "RequiredUserName", "Requisicion",
                "Responsable", "Reunion", "ReunionDiariaAgregada", "ReunionesAsistidas", "ReunionesProgramadas", "ReunionesConSuplencias",
