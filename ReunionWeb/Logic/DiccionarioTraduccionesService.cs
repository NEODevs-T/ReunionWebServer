    ...
    public class DiccionarioTraduccionesService : IDiccionarioTraduccionesService
    {
        ...
        public async Task CargarTraduccionesAsync()
        {
            var claves = new[]
            {
                ...
                "ExcluirLosDiasNoLaborables", "Exito", "FReunion", "F_Reunion", "FalloR",
                "FaltaDePersonal", "FaltaRepuesto", "FechaDeReunion", "FechaDelCambio", "FechaDelTrabajo",
                ...
                "Trazabilidad", "Usuario", "VencidasTurno", "Vencidos", "VerifiqueCampos",
